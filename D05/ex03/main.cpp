...
/*   Updated: 2018/03/13 14:36:31 by mbaron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	Form						* formPP = intern.makeForm("presidential pardon", "Target");
	Form						* formRR = intern.makeForm("robotomy request", "Target");
	Form						* formSC = intern.makeForm("shrubbery creation", "home");
	Form						* formKO = intern.makeForm("Bidule", "home");
	
	std::cout << jack80 << jack20 << jim20 << jack3 << *formPP << *formRR << *formSC << formKO;
