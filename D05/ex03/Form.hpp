...
/*   Updated: 2018/03/13 14:28:42 by mbaron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Form
{
	public:
		...
		{
			public:
				FormNotFindException(void);
				FormNotFindException(FormNotFindException const & src);
				~FormNotFindException(void) throw();
				
				FormNotFindException	& operator=(FormNotFindException const & rhs);
				char const				* what() const throw();
		};
		...
		static	Form		* getForm(std::string const & name, std::string const & target) throw(Form::FormNotFindException);
