...
/*   Updated: 2018/03/08 16:47:52 by mbaron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ScavTrap.hpp"

unsigned int const ScavTrap::_hit_max = 50;
...
{
	return ((this->*_challenges[ScavTrap::getRandomInt(ScavTrap::_challenges_nb)])(target));
}
/*********************************************************************
